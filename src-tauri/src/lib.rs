...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![scan_games, create_zip, compute_save_hash, extract_zip, read_zip_meta, get_oauth_redirect_uri, start_oauth, send_native_notification, scan_manual_game, pick_folder, keychain_set, keychain_get, keychain_delete])
        .setup(|app| {
